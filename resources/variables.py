...
# Titles
CAREERS_WEB_TITLE = "Careers - Orion Innovation"

# Scroll to block
MATURITY_SCALE = '//*[@id="h-maturity-scale"]'
AGREE_TO_COMMUNICATE = '//*[@id="field_1_12"]'
SAVE_INFO = '//*[@id="label_7_13_1"]'
...
SEARCH_MATCHES = '//*[@id="content"]/div[2]/div/div/div[2]/div[3]'

# Buttons
HEADER_SEARCH_BUTTON = '/html/body/header/div/nav/div[3]'
...
# Name
CV_NAME = "git-cheat-sheet-education"
SEARCING_NAME = 'lithuania'

# Inputs
SEARCH_INPUT = '//*[@id="search-form-wrapper"]/form/input[1]'